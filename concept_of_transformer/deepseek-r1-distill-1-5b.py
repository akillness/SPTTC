...
# 모델 및 토크나이저 로드
tokenizer = AutoTokenizer.from_pretrained(model_name, cache_dir=custom_cache_dir, trust_remote_code=True)
# decoder 모델 로드시 사용
model = AutoModelForCausalLM.from_pretrained(model_name, cache_dir=custom_cache_dir, config=config, trust_remote_code=True)
